...
class SequenceGroup:
    ...
    def is_finished(self) -> bool:
        ...
        if self.sampling_params.n and self.sampling_params.generate_redundancy_num:
            # print([seq.is_finished() for seq in self.seqs if seq.is_finished()])
            # import pdb; pdb.set_trace()
            return len([seq for seq in self.seqs if seq.is_finished()]) >= (self.sampling_params.n - self.sampling_params.generate_redundancy_num)
