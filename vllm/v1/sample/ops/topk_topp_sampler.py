...
class TopKTopPSampler(nn.Module):
    ...
    def forward_native(
        ...
        """
        # print(f"[DEBUGUGUGUGUUGU] HEHEHEHHEEHEHHEHRHRHHRRHRHRHRH+++++++ I IIIIII GOUGPGPUGUPGT YOYOOYYOYOYOYOU")
