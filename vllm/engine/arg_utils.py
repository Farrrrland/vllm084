...
class EngineArgs:
    ...
    def create_engine_config(
        ...
        use_v1 = False
        print(f"[DEBUG] envs.VLLM_USE_V1: {envs.VLLM_USE_V1}, envs.is_set(VLLM_USE_V1): {envs.is_set('VLLM_USE_V1')}")
        try_v1 = envs.VLLM_USE_V1 or not envs.is_set("VLLM_USE_V1")
        print(f"[DEBUG] try_v1: {try_v1}, self._is_v1_supported_oracle(model_config): {self._is_v1_supported_oracle(model_config)}")
