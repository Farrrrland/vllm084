...
from typing import Any, Callable, ClassVar, Optional, Union, cast, overload, List
import time
import cloudpickle
...
class LLM:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print(f"HIHIHIHIHIHIHHIHIHIHHIHIHIHI")
    ...
    def generate(
        ...
        outputs = self._run_engine(use_tqdm=use_tqdm, sampling_params=sampling_params)
    ...
    def _run_engine(
        ...
        while self.llm_engine.has_unfinished_requests():
            ...
            for output in step_outputs:
                if output.finished:
                    if sampling_params.generate_redundancy_num:
                        # import pdb; pdb.set_trace()
                        selected_n = sampling_params.n - sampling_params.generate_redundancy_num
                        output.outputs = output.outputs[:selected_n]
